  ...
  async execute(interaction) {
    ...
    if (country == "USA") {
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "Special thanks to ネGoldenネ#8782 for assistance with links",
        });
      ...
      const embed = new EmbedBuilder()
       ...
       [therapyroute.com](https://www.therapyroute.com/article/suicide-hotlines-and-crisis-lines-in-portugal)`
        ...
        .setFooter({
          text: "Special thanks to =LLL=#0711 for the country information and assistance with links",
        });
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "Special thanks to ネGoldenネ#8782 and Ayrton#8115 for assistance with links",
        });
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "Special thanks to ネGoldenネ#8782 bunnie.#8448 and for assistance with links",
        });
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "Special thanks to Lance🔑#4823 for assistance with links",
        });
      ...
      const embed = new EmbedBuilder()
        ...
        .setFooter({
          text: "Special thanks to =LLL=#0711 for assistance with links",
        });

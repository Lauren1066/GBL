...
module.exports = {
  data: new SlashCommandBuilder().setName("fakewelcomeagain").setDescription("Emit the welcome event!"),
  async execute(interaction) {
    ...
    const filePath = path.join(__dirname, "/wallpaper.jpeg");
    ...
    ctx.fillText(`${interaction.user.tag}`, middleWdith + 225, canvas.height / 2.3);

    ctx.fillStyle = "#ffffff";
    ctx.fillText(`You are Member #${interaction.guild.memberCount}`, middleWdith + 225, canvas.height / 1.5);
